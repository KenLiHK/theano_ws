# -*- coding: utf-8 -*-
"""
Created on Tue Jun 13 05:42:48 2017

This code is referring to the code from this link:
https://www.youtube.com/watch?v=Bn3VWIwxxXg&list=PLXO45tsB95cKpDID642AjNkygrSR5X15T&index=17
https://github.com/MorvanZhou/tutorials/blob/master/theanoTUT/theano12_regularization/full_code.py
...
print('*** theano_tu08.py ***')
print('*** theano_tu08, theano regularization ***')
